...
from clinic.patient.permissions import (
    IsOwnerDoctorOrReadOnly, IsDoctorOrReadOnly, IsOwnerOrDoctor,
    IsOwnerDoctorOrIsOwnerPatient, IsOwnerPatient, IsOwnerOrDoctorReadOnly
)
from clinic.models import (
    Patient, Prescription, MedicalRecord, FavouriteDoctor, Appointment, Invoice, DoctorSchedule
)
from clinic.patient.serializers import (
    PatientSerializer, PrescriptionSerializer, MedicalRecordSerializer, FavouriteDoctorSerializer,
